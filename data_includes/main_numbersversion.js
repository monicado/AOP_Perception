...
newTrial("Instructions",
    ...
    .print()
    ,
    newText("instruct","<p>1. Each trial in this experiment will start with an image. Remember that image as best you can.</p> <p>2. Afterwards, you will be asked to solve some simple math problems. 3. When you complete those, you will be shown a second image. Your job is to decide if the second image you see is <i>exactly</i> the same as the first. Select <b>Yes</b> if the images were <i>exactly</i> the same, and <b>No</b> otherwise.</p><p>If you can't remember the numbers or if you can't remember the images, just take your best guess! You will be given a few short breaks at different points in the study.</p>")
    .center()
    .print()
    ,
