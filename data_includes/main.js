...
newTrial("Instructions",
    newText("instruct","<p>At the beginning of each trial, you will be shown a sequence of numbers. You will have 3 seconds to remember those numbers in order as best you can. After the numbers disappear, you will be shown two images. The first image will remain on the screen for 2 seconds and then a second image will appear. Your job it to decide whether the second image you saw was <i>exactly</i> the same as the first. Select <b>Yes</b> if the images were <i>exactly</i> the same, and <b>No</b> otherwise. After you make your selection, you will be asked to type the numbers you saw into a box. If you can't remember the numbers or if you can't remember the images, just take your best guess!</p><p>You will be given the opportunity to take a short break at 4 different points in the study.</p>")
    .print()
    ,
...
PennController.SendResults();
 ...
 // END THANK YOU
 newTrial("EndScreen",
     newText("<p>Thank you for your participation! If you have questions about this research you may contact the researcher Dr. Monica Do at monicado@uchicago.edu.</p><p><b>Please enter the following code on mturk to receive credit: 4537020 </b></p>")
         .print()
     ,
     newButton("void")
         .wait()
